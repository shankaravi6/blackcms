...
const AllPremPromptData = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`${BASE_URL}/api/data/${"prem_promptrix_data"}`)
      .then((response) => {
  ...
  const handleEdit = (id) => {
    navigate(`/prempromptrix/edit/${id}`);
  };
...
export default AllPremPromptData;
